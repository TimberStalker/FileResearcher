...
namespace FileReading.Utils
{
    public class DynamicDictionary<TKey, TValue> : IEnumerable<KeyValuePair<DynamicDictionary<TKey, TValue>.Key, TValue>>, where TKey : notnull
    {
        ...
        public DynamicDictionary(params (TKey, TValue)[] addValues) : this()
        {
        ...
        public Key GetKey(int i) => order[i];
        public bool Insert(TKey key, TValue value, Index index)
        {
            ...
            order.Insert(index.GetOffset(Count), realKey);
